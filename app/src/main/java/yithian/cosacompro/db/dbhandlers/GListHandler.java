...
public class GListHandler extends SQLiteOpenHelper {
    ...
    private static GListHandler mInstance;
     ...
     */
    public static GListHandler getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new GListHandler(context.getApplicationContext());
        }
        return mInstance;
    }
     ...
     */
    private GListHandler(Context context) {
